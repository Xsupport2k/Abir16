...
(5, '🇵🇭', 'ph', 'فیلیپین', 'philippines', 63, 5000, 0, 1),
(6, '🇲🇲', 'mm', 'میانمار', 'myanmar', 95, 5000, 0, 1),
(7, '🇮🇩', 'id', 'اندونزی', 'indonesia', 62, 5000, 0, 1),
(8, '🇲🇾', 'my', 'مالزی', 'malaysia', 60, 5000, 0, 1),
(9, '🇰🇪', 'ke', 'کنیا', 'kenya', 254, 5000, 0, 1),
(10, '🇹🇿', 'tz', 'تانزانیا', 'tanzania', 255, 5000, 0, 1),
(11, '🇻🇳', 'vn', 'ویتنام', 'vietnam', 84, 5000, 0, 1),
(12, '🏴󠁧󠁢󠁥󠁮󠁧󠁿', 'gb', 'انگلستان', 'england', 44, 5000, 0, 1),
(13, '🇱🇻', 'lv', 'لتونی', 'latvia', 371, 5000, 0, 1),
(14, '🇷🇴', 'ro', 'رومانی', 'romania', 40, 5000, 0, 1),
(15, '🇪🇪', 'ee', 'استونی', 'estonia', 372, 5000, 0, 1),
(16, '🇺🇸', 'us', 'آمریکا', 'usa', 1, 5000, 0, 1),
(18, '🇰🇬', 'kg', 'قرقیزستان', 'kyrgyzstan', 996, 5000, 0, 1),
